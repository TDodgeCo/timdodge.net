...
export default class Profiles extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.string('twitch_url', 255).nullable().defaultTo('')
      table.string('soundcloud_url', 255).nullable().defaultTo('')
      table.string('spotify_url', 255).nullable().defaultTo('')
      table.string('discord_url', 255).nullable().defaultTo('')
      /**

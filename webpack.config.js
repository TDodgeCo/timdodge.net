...
Encore.addEntry('js808', './resources/js/projects/js808.ts')
Encore.addEntry('js808Test', './resources/js/projects/js808Test.ts')
Encore.addEntry('audioContext', './resources/js/projects/audioContext.ts')
...
Encore.copyFiles({
  from: './resources/js/scripts',
  to: 'scripts/[path][name].[hash:8].[ext]',
})
Encore.copyFiles({
  from: './resources/audio/808',
  to: 'audio/[path][name].[hash:8].[ext]',
})

Encore.copyFiles({
  from: './resources/js/projects',
  to: 'js/projects/[path][name].[hash:8].[ext]',
